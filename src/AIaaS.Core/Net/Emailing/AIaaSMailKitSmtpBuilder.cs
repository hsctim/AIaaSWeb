...
{
    public class AIaaSMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public AIaaSMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(AIaaSConsts.LocalizationSourceName, name);
    }
}
}