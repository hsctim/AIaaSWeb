...
namespace AIaaS.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : AIaaSServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("AIaaS", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
