...
{
    public class StripeGatewayManager : AIaaSServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ChatPal.Ai";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + AIaaSConsts.Currency;
        }
