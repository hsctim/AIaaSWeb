...
namespace AIaaS.Features
{
    public class AppFeatureProvider : FeatureProvider
    {
        public override void SetFeatures(IFeatureDefinitionContext context)
        {
            ...
            context.Create(
                    AppFeatures.MaxChatbotCount,
                    defaultValue: "0", //0 = unlimited
                    displayName: L("MaximumChatbotCount"),
                    description: L("MaximumChatbotCount_Description"),
                    inputType: new SingleLineStringInputType(new NumericValueValidator(0, int.MaxValue))
            )[FeatureMetadata.CustomFeatureKey] = new FeatureMetadata
            {
                IsVisibleOnPricingTable = true,
            ...
            context.Create(
                    AppFeatures.MaxQuestionCount,
                    defaultValue: "0", //0 = unlimited
                    displayName: L("MaximumQuestionCount"),
                    description: L("MaximumQuestionCount_Description"),
                    inputType: new SingleLineStringInputType(new NumericValueValidator(0, int.MaxValue))
            )[FeatureMetadata.CustomFeatureKey] = new FeatureMetadata
            {
                IsVisibleOnPricingTable = true,
            ...
            context.Create(
                    AppFeatures.MaxProcessingUnitCount,
                    defaultValue: "0", //0 = unlimited
                    displayName: L("MaxProcessingUnitCount"),
                    description: L("MaxProcessingUnitCount_Description"),
                    inputType: new SingleLineStringInputType(new NumericValueValidator(0, int.MaxValue))
            )[FeatureMetadata.CustomFeatureKey] = new FeatureMetadata
            {
                IsVisibleOnPricingTable = true,
            ...
            //context.Create(
            //        AppFeatures.MaxModelTraining,
            //        defaultValue: "0", //0 = unlimited
            //        displayName: L("MaximumModelTrainingCount"),
            //        description: L("MaximumModelTrainingCount_Description"),
            //        inputType: new SingleLineStringInputType(new NumericValueValidator(0, int.MaxValue))
            //    )[FeatureMetadata.CustomFeatureKey] = new FeatureMetadata
            //    {
            //        ValueTextNormalizer = value => value == "0" ? L("Unlimited") : new FixedLocalizableString(value),
            ...
            //context.Create(
            //        AppFeatures.MaxAnswerSent,
            //        defaultValue: "0", //0 = unlimited
            //        displayName: L("MaximumAnswerSentCount"),
            //        description: L("MaximumAnswerSentCount_Description"),
            //        inputType: new SingleLineStringInputType(new NumericValueValidator(0, int.MaxValue))
            //    )[FeatureMetadata.CustomFeatureKey] = new FeatureMetadata
            //    {
            //        ValueTextNormalizer = value => value == "0" ? L("Unlimited") : new FixedLocalizableString(value),
