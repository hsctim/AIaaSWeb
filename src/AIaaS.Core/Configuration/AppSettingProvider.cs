    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            ...
            return GetHostSettings().Union(GetTenantSettings()).Union(GetSharedSettings())
                ...
                .Union(GetExternaData());
                //.Union(GetExternalService());
        ...
        {
            if (!AIaaSConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        AIaaSConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        AIaaSDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        AIaaSDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = AIaaSDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page
                    {
                        Name = AIaaSDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = AIaaSDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    AIaaSDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
                {
                    DashboardName = AIaaSDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = AIaaSDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId = AIaaSDashboardCustomizationConsts.Widgets.Tenant
                                        .QAStatistics, // Subscription Summary
                                    Height = 10,
                                    Width = 6,
                                    PositionX = 6,
                                    PositionY = 1
                                ...
                                {
                                    WidgetId = AIaaSDashboardCustomizationConsts.Widgets.Tenant
                                        .VisitorStatistics, // Subscription Summary
                                    Height = 10,
                                    Width = 6,
                                    PositionX = 0,
                                    PositionY = 5
                                ...
                                {
                                    WidgetId =
                                        AIaaSDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                //{
                                //    WidgetId = AIaaSDashboardCustomizationConsts.Widgets.Tenant
                                //        .SubscriptionStats, // Subscription Summary
                                //    Height = 5,
                                //    Width = 3,
                                //    PositionX = 0,
                                //    PositionY = 0
        ...
        //private SettingDefinition[] GetExternalService()
        //{
        //    return new[]
        //    {
        //        new SettingDefinition(
        //            AppSettings.NlpService.PythonChatbotApiURL,
        //            GetFromAppSettings(AppSettings.NlpService.PythonChatbotApiURL,                "http://127.0.0.1:5555"),
        //            isVisibleToClients: false,
        //            scopes: SettingScopes.Application ),

        //        new SettingDefinition(
        //            AppSettings.NlpService.HostChatbotId,
        //            GetFromAppSettings(AppSettings.NlpService.HostChatbotId,
        //            ""),
        //            isVisibleToClients: false,
        //            scopes: SettingScopes.Application ),
        //    };
        ...
        private SettingDefinition[] GetExternaData()
        {
            //美金/台幣 匯率
            return new[]
            {
                new SettingDefinition(
                    AppSettings.ExternalData.GetForeignExchangeRateUSD_NTD,
                    GetFromAppSettings(AppSettings.ExternalData.GetForeignExchangeRateUSD_NTD,
                    "0"),
                    isVisibleToClients: false,
                    scopes: SettingScopes.Application ),
            };
