namespace AIaaS.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        //{
        //    public const string PythonChatbotApiURL = "App.NlpChatbot.PythonChatbotApiURL";
        //    public const string HostChatbotId = "App.NlpChatbot.HostChatbotId";
        //}

        public static class ExternalData
        {
            public const string GetForeignExchangeRateUSD_NTD = "ExternalData.GetForeignExchangeRateUSD_NTD";
        }
