namespace AIaaS
{
    public class AIaaSDashboardCustomizationConsts
    {
        /// <summary>
        ...
        public class Widgets
        {
            public class Tenant
            {
                ...
                public const string SubscriptionSummary = "Widgets_Tenant_SubscriptionSummary";
                public const string QAStatistics = "Widgets_Tenant_QAStatistics";
                public const string VisitorStatistics = "Widgets_Tenant_VisitorStatistics";
