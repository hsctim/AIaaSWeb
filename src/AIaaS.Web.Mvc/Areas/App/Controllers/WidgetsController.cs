...
namespace AIaaS.Web.Areas.App.Controllers
{
    ...
    [AbpMvcAuthorize]
    [DisableAuditing]
    public class WidgetsController : AIaaSControllerBase
    {
        #region Host
        ...
        {
            return PartialView("Components/CustomizableDashboard/Widgets/QAStatistics");
        }

        [AbpMvcAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
        public IActionResult SubscriptionSummary()
        {
            return PartialView("Components/CustomizableDashboard/Widgets/SubscriptionSummary");
        }

        [AbpMvcAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
        public IActionResult VisitorStatistics()
        {
            return PartialView("Components/CustomizableDashboard/Widgets/VisitorStatistics");
        }
