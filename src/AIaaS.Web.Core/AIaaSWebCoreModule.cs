...
using AIaaS.Authentication.TwoFactor;
using AIaaS.Chat;
using AIaaS.Configuration;
using AIaaS.EntityFrameworkCore;
using AIaaS.Startup;
using AIaaS.Web.Authentication.JwtBearer;
using AIaaS.Web.Authentication.TwoFactor;
using AIaaS.Web.Chat.SignalR;
using AIaaS.Web.Common;
using AIaaS.Web.Configuration;
...
{
    [DependsOn(
        typeof(AIaaSApplicationModule),
        typeof(AIaaSEntityFrameworkCoreModule),
    ...
    public class AIaaSWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AIaaSWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(AIaaSApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AIaaSWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(AIaaSWebCoreModule).Assembly);
        }
