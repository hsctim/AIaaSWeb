...
{
    public class AIaaSAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public AIaaSAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
