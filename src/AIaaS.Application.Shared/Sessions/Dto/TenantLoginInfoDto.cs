...
namespace AIaaS.Sessions.Dto
{
    public class TenantLoginInfoDto : EntityDto
    {
        ...
        public int GetSubscriptionExpiringDayCount()
        {
            ...
            return Math.Max(Convert.ToInt32(SubscriptionEndDateUtc.Value.ToUniversalTime().Subtract(Clock.Now.ToUniversalTime()).TotalDays), 0);
        }
