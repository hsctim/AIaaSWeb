...
using AIaaS.Controls;
using AIaaS.Dto;
using AIaaS.Extensions;
using AIaaS.Localization;
using AIaaS.UI;
using AIaaS.UI.Assets;
using AIaaS.Views;
using DependencyResolver = AIaaS.Core.Dependency.DependencyResolver;
...
namespace AIaaS.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "AIaaS";
