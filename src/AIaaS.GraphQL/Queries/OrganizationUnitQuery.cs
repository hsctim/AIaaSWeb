...
using AIaaS.Core.Base;
using AIaaS.Core.Extensions;
using AIaaS.Dto;
using AIaaS.Types;

namespace AIaaS.Queries
{
    public class OrganizationUnitQuery : AIaaSQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
