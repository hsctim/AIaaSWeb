...
{
    [DependsOn(
        typeof(AIaaSWebCoreModule)
    )]
    public class AIaaSWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AIaaSWebFrontEndModule(IWebHostEnvironment env, AIaaSEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AIaaSWebFrontEndModule).GetAssembly());
        }
    }
}
