...
using AIaaS.Url;
using AIaaS.Web.Public.Startup;
using AIaaS.Web.Session;
using AIaaS.Web.UiCustomization;

namespace AIaaS.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : AIaaSViewComponent
    {
