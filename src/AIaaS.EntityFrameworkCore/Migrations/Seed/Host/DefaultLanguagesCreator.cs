...
namespace AIaaS.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AIaaSConsts.MultiTenancyEnabled ? null : (int?)1;
            var supportLanguages = new List<ApplicationLanguage>
            {
                new ApplicationLanguage(tenantId, "zh-Hant", "繁體中文", "famfamfam-flags"),
                new ApplicationLanguage(tenantId, "zh-Hans", "简体中文", "famfamfam-flags"),
                new ApplicationLanguage(tenantId, "en", "English", "famfamfam-flags"),                
        ...
        public DefaultLanguagesCreator(AIaaSDbContext context)
        {
            _context = context;
        }
