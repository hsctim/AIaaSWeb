...
namespace AIaaS.Organizations
{
    public class UserOrganizationUnitRepository : AIaaSRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<AIaaSDbContext> dbContextProvider)
