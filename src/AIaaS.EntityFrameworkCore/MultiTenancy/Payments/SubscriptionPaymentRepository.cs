...
{
    public class SubscriptionPaymentRepository : AIaaSRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<AIaaSDbContext> dbContextProvider)
