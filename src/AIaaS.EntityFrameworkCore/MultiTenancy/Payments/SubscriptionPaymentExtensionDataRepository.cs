...
{
    public class SubscriptionPaymentExtensionDataRepository : AIaaSRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<AIaaSDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
