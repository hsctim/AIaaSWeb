...
using AIaaS.Authorization.Users.Password;
using AIaaS.Configuration;
using AIaaS.EntityFrameworkCore;
using AIaaS.MultiTenancy;
using AIaaS.Web.Startup.ExternalLoginInfoProviders;
...
namespace AIaaS.Web.Startup
{
    ...
    public class AIaaSWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AIaaSWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AIaaSWebHostModule).GetAssembly());
        }
