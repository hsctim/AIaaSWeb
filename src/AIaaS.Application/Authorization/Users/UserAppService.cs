...
using AIaaS.Authorization.Users.Exporting;
using AIaaS.Dto;
...
namespace AIaaS.Authorization.Users
{
    ...
    public class UserAppService : AIaaSAppServiceBase, IUserAppService
    {
        ...
        private List<User> GetAllUsersByEmail(string inputEmailAddress)
        {
        ...
        [RemoteService(false)]
        public async Task<LicenseUsage> GetUserLicenseUsage()
        {
            var usageCount = UserManager.Users.Count(e => e.IsDeleted == false);
