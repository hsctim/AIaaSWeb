...
namespace AIaaS.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AIaaSAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AIaaSDbContext> _migrator;
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{AIaaSConsts.ConnectionStringName}", constring);
        }
