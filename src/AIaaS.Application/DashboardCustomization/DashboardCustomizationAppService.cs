...
using static AIaaS.AIaaSDashboardCustomizationConsts.Widgets;

namespace AIaaS.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : AIaaSAppServiceBase, IDashboardCustomizationAppService
    {
        ...
        public DashboardOutput GetDashboardDefinition(GetDashboardInput input)
        {
            ...
            return new DashboardOutput(
                ...
                usedWidgetDefinitions
                    ...
                    .WhereIf(
                    AbpSession.TenantId.HasValue && AbpSession.TenantId > 1,
                    e => e.Id == Tenant.SubscriptionSummary ||
                    e.Id == Tenant.QAStatistics ||
                    e.Id == Tenant.VisitorStatistics).ToList()
            );
        }
        ...
        private async Task SaveDashboardSettingForUser(string application, Dashboard dashboard)
        {
            ...
            //    Logger.Fatal("UnknownWidgetId:" + unknownWidgetId);
