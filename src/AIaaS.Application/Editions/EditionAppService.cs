...
{
    public class EditionAppService : AIaaSAppServiceBase, IEditionAppService
    {
        ...
        [RemoteService(false)]
        public async Task<int> GetFreeEditionId()
        {
            var edition = await GetFreeEdition();
            return edition.Id;
        }


        private async Task<SubscribableEdition> GetFreeEdition()
        {
            var edition = await _editionRepository.FirstOrDefaultAsync(e => e.AnnualPrice == null && e.MonthlyPrice == null && e.WeeklyPrice == null && e.DailyPrice == null && e.Name == "Free");

            edition ??= await _editionRepository.FirstOrDefaultAsync(e => e.AnnualPrice == null && e.MonthlyPrice == null && e.WeeklyPrice == null && e.DailyPrice == null);
