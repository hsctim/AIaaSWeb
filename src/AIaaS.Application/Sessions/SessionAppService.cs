...
{
    public class SessionAppService : AIaaSAppServiceBase, ISessionAppService
    {
        ...
        [ApiProtector(ApiProtectionType.ByIpAddress, Limit: 20, TimeWindowSeconds: 20)]
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        CurrencySign = AIaaSConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = AIaaSConsts.AllowTenantsToChangeEmailSettings,
                ...
                if (AbpSession.UserId.HasValue)
                {
                    ...
                    if (output.User != null)
                    {
                        _cacheManager.Set_UserLoginInfoDto(output.User.Id, output.User);
                    }
                }
