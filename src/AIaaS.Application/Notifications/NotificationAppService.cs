...
using AIaaS.Organizations;
using ApiProtectorDotNet;

namespace AIaaS.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : AIaaSAppServiceBase, INotificationAppService
    {
        ...
        [ApiProtector(ApiProtectionType.ByIdentity, Limit: 20, TimeWindowSeconds: 20)]
