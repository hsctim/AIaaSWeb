...
namespace AIaaS.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (AbpSession.TenantId.HasValue == false || AbpSession.TenantId.Value > 1)
            {
                input = new TenantSettingsEditDto()
                {
                    Billing = new TenantBillingSettingsEditDto()
                    {
                        Address = "",
                        LegalName = "",
                        TaxVatNo = ""
                    ...
                    UserManagement = new TenantUserManagementSettingsEditDto()
                    {
                        ...
                        {
                            IsEnabled = false,
                            ShowLockScreenWhenTimedOut = false,
                            ShowTimeOutNotificationSecond = 90,
                            TimeOutSecond = 1200,
                        }
                    },
                    Email = input.Email,
                    ExternalLoginProviderSettings = input.ExternalLoginProviderSettings,
                    ...
                    Security = new SecuritySettingsEditDto()
                    {
                        ...
                        DefaultPasswordComplexity = input.Security.DefaultPasswordComplexity,
                        ...
                        TwoFactorLogin = input.Security.TwoFactorLogin,
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !AIaaSConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
