...
using AIaaS.DemoUiComponents.Dto;

namespace AIaaS.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : AIaaSAppServiceBase, IDemoUiComponentsAppService
    {
