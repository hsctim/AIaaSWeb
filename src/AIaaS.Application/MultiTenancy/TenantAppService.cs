...
namespace AIaaS.MultiTenancy
{
    ...
    public class TenantAppService : AIaaSAppServiceBase, ITenantAppService
    {
        public IAppUrlService AppUrlService { get; set; }
        public IEventBus EventBus { get; set; }

        public INlpChatbotsAppService _nlpChatbotsAppService { get; set; }

        public TenantAppService(INlpChatbotsAppService nlpChatbotsAppService)
        {
        ...
        public async Task CreateTenant(CreateTenantInput input)
        {
            ...
            await _nlpChatbotsAppService.CreateChatbotSampleAsync(tenantId, null);
