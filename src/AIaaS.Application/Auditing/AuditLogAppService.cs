...
using AIaaS.Auditing.Exporting;
using AIaaS.Authorization;
using AIaaS.Authorization.Users;
using AIaaS.Dto;
using AIaaS.EntityHistory;
using EntityHistoryHelper = AIaaS.EntityHistory.EntityHistoryHelper;
...
namespace AIaaS.Auditing
{
    ...
    public class AuditLogAppService : AIaaSAppServiceBase, IAuditLogAppService
    {
