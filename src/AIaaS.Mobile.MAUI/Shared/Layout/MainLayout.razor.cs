...
using AIaaS.Mobile.MAUI.Services.Account;
using AIaaS.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using AIaaS.Mobile.MAUI.Services.Tenants;

#if ANDROID
using AIaaS.Mobile.MAUI.Platforms.Android.HttpClient;
#endif

namespace AIaaS.Mobile.MAUI.Shared.Layout
{
...
#elif IOS
            var abpHttpClientFactory = new AIaaS.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
