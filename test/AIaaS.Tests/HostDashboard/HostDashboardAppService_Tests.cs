...
using AIaaS.MultiTenancy.HostDashboard;
...
namespace AIaaS.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(AIaaSDbContext context, SubscriptionPayment subscriptionPayment)
        {
